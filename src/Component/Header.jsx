    ...
    <header class="shadow-md font-[sans-serif] tracking-wide relative z-50 ">
      <section class="md:flex lg:items-center relative py-3 lg:px-10 px-4 border-gray-200 border-b bg-white lg:min-h-[80px] max-lg:min-h-[60px]">
        <a href="javascript:void(0)" class="max-sm:w-full max-sm:mb-3 shrink-0">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0G7Vjh6B55yJJevk-6-UtfS3vYMGQmt51xw&s"
            alt="logo"
        ...
        <div class="flex flex-wrap w-full items-center">
          ...
          <div class="ml-auto max-lg:mt-4">
            <ul class="flex items-center">
              <li class="max-sm:hidden flex text-[15px] max-lg:py-2 px-3 font-medium text-[#333] cursor-pointer">
                <svg
              ...
              <li class="max-lg:py-2 px-3 cursor-pointer">
                <Link to="/cart" span class="relative">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
                    height="20px"
              ...
              <li class="flex text-[15px] max-lg:py-2 px-3 hover:text-[#007bff] hover:fill-[#007bff]">
                <button class="px-4 py-2 text-sm rounded font-semibold text-[#333] border-2 border-[#333] bg-transparent">
                  Sign In
                </button>
              </li>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <ul class="lg:flex lg:flex-wrap lg:items-center lg:justify-center px-10 py-3 bg-[#333] min-h-[46px] gap-4 max-lg:space-y-4 max-lg:fixed max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
