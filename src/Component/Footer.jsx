...
function Footer() {
  return (
    <footer class="bg-gray-800 py-5 font-sans tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        <div>
          <h4 class="text-lg font-semibold mb-6 text-white">About Us</h4>
          <p class="text-gray-400 text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida, mi eu
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Web Development</a></li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Mobile App Development</a>
            </li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">UI/UX Design</a></li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Digital Marketing</a></li>
          </ul>
        </div>
      ...
      <div class="bg-gray-900 p-5 mt-12">
        <p class='text-gray-400 text-base text-center'>© ReadymadeUI. All rights reserved.</p>
      </div>
    </footer>
  )
}
